...
export default function EditGreigeInspection() {
    ...
    try {
      const response = await fetch(
        `http://${localStorage.getItem(
          "server-ip"
        )}/inspaction/get_greige_inspection_data`,
        {
          method: "POST",
          headers: {
    ...
    if (batch == "Select batch...") {
      ...
      try {
        const url = `http://${localStorage.getItem(
          "server-ip"
        )}/inspaction/update_greige_inspection`;
        const options = {
          method: "POST",
          headers: {
            Accept: "application/json",
  ...
  const updateInspectionWWW = async () => {
    if (batch == "Select batch...") {
      ...
      try {
        const url = `http://${localStorage.getItem(
          "server-ip"
        )}/inspaction/update_greige_inspection_www`;
        const options = {
          method: "POST",
          headers: {
            Accept: "application/json",
  ...
  return (
    <div className="card-container">
      <div className="top-section">
        ...
        <div className="head-title">Edit Greige Inspection</div>
