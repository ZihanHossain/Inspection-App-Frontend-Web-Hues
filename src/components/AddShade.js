...
export default function AddShade() {
  ...
  useEffect(() => {
    document.title = "Add Shade";
    if (localStorage.getItem("token") == null) {
      navigate("/");
    } else {
      if (!localStorage.getItem("permissions").includes("add_shade")) {
  ...
  return (
    <div className="card-container">
      <HeaderBar title="Add Shade" module="fabric" />
                ...
                <div className="info-table">
                  <TableContainer component={Paper} sx={{ height: "100%" }}>
                    <Typography
                      ...
                      variant="h6"
                    >
                      <span className="typography">Assign Shade</span>
                    </Typography>
                    <Table
                      stickyHeader
                      sx={{ minWidth: 400 }}
                ...
                <div className="info-table">
                  <TableContainer component={Paper} sx={{ height: "100%" }}>
                    <Typography
                      ...
                      variant="h6"
                    >
                      <span className="typography">Saved Shade</span>
                    </Typography>
                    <Table
                      sx={{ minWidth: 400 }}
                      stickyHeader
                        ...
                        {rolls.map((row) =>
                          !row.shade ? (
                            ...
                            >
                              ...
                              <TableCell align="center">{row.shade}</TableCell>
                            </TableRow>
                          )
                        )}
                      </TableBody>
